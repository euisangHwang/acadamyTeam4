...
<body>
	...
	<div style="width: 100%; height: 900px; border: 1px solid">
		...
		<div style="border: 1px solid; height: 700px">
			...
			<!-- 중앙  위 가운데 네모칸 -->
			<div style="border: 1px solid; height: 450px">CCTV 보러가기</div>
			<!-- 중앙 위 가운데 네모칸 -->
			...
			<div style="border: 1px solid; height: 250px">
				...
				<!-- 중앙 아래 가운데 속 왼쪽 네모칸  -->
				<div style="border: 1px solid; height: 125px; float:left; width:45%;"></div>
				<!-- 중앙 아래 가운데 속 왼쪽 네모칸 끝 -->

				<!-- 중앙 아래 가운데 속 오른쪽 네모칸  -->
				<div style="border: 1px solid; height: 125px; float:right; width:45%;"></div>
				<!-- 중앙 아래 가운데 속 오른쪽 네모칸 끝 -->
