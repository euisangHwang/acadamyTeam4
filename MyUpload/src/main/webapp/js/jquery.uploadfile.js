...
*/                    
        ...
        function f(a, t) { //a는 파일이름 담겨있는 버튼객체, t는 form값이 없는  설정값
            ...
            alert("이거 div아냐?? ::: "+$(this.statusbar).attr("class"));
        ...
        function m(a, t) { //a는 파일이름 담겨있는 버튼객체, t는 form값이 없는  설정값
            ...
            r = t.customProgressBar ? new t.customProgressBar(a,t) : new f(a,t);
            alert("이게 r이지??"+r+" ::: "+$(r).attr("class"));
            console.log("r은 대체 뭐냐 시발"+r);
            return r,
